...
def likelihood_both(env_name='Walker2d-v2', model_name='DRBCQ', traj=5, seed=0, in_sample=True):
    """
    Compute the likelihood of the entire trajectory
    :param env_name:
    :param model_name:
...
def plot_distribution(env_name='Walker2d-v2', model_name='BC', sample_traj=50, traj=5, seed=0, type='good'):
    """
...
def analyze_model_with_noise(env_name='Walker2d-v2', model_name='GAIL', num_trajs=[1,3,5],
    ...
    plt.savefig('plots/{}_{}_noise1{}_noise2{}_seed2020.png'.format(model_name, env_name, noise1, noise2))
    plt.close()
...
def analyze_bcq_with_noise(env_name='Walker2d-v2', model_name='BCQ', num_trajs=[5],
                                 seeds=[0,1,2], type='good', noise1=0, noise2=0.3):
    """
    Robustness test.
    :param env_name:
    :param model_name:
...
if __name__ == "__main__":
    ...
    # analyze_bcq_with_noise(model_name='DRBCQ')